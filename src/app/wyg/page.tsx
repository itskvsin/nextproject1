...
const features: Feature[] = [
  {
    icon: "🎯",
    title: "Conversion-Centric Ad Creatives",
    description: "Every video is designed to boost engagement and drive sales.",
    image: "/images/wyg1.jpg",
  },
  {
    icon: "🧪",
    title: "Multiple Hooks for A/B Testing",
    description:
      "We develop several opening angles to discover what resonates best with your audience.",
    image: "/images/wyg2.jpg",
  },
  {
    icon: "👤",
    title: "Diverse Actor Selection",
    description:
      "Choose from our in-house database of on-screen talent to find the perfect match for your brand.",
    image: "/images/wyg3.jpg",
  },
  {
    icon: "⚡",
    title: "Parallel Integration for Faster Turnaround",
    description:
      "Scripting, casting, and location scouting happen simultaneously to save time.",
  ...
  },
  {
    ...
    description:
      "All shoots use a Sony Alpha a7 III — never just a smartphone camera.",
